...
var express = require('express'),
	...
	mongourl = process.env['MONGOHQ_URL'] ||  'mongodb://localhost/hack',
...
app.configure(function(){
	...
	app.use(function(err, req, res, next){
		...
		res.status(500).render('layout', { tmpl: 500, msg: 'hack Server Error, terribly sorry, please try again in a couple minutes.' });
	});
});
